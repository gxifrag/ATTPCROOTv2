...
void run_ana_8He_multi(TString FileNameHead = "8He_TRIUMF_run_", Int_t num_ev = 3000000, Int_t file_ini = 200,
                       Int_t file_end = 210, Int_t runnum = 1, Float_t HoughDist = 2.0, Bool_t debug = kTRUE,
