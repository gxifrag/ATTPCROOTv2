...
void fision5_y()
{
   ...
   TH2D *XY_dist2 =
      new TH2D("his102", "position distribution of the lost fragments  (Twin cathode)", 1000, -10, 10, 1000, -10, 10);
   TH2D *XY_dist3 = new TH2D("his103", "position distribution of the detected fragments xVSy (Twin cathode)", 1000,
   ...
   *out << " Lorentz factor (gamma) \t" << gamma << endl;
   ...
   for (k = 1; k <= 20000; k++) {
      ...
      TKE = (0.00144 * Z1 * Z2) /
            (1.16 * (pow(A1, 1. / 3.) * (1. + 2. / 3. * 0.6) + pow(A2, 1. / 3.) * (1. + 2. / 3. * 0.6)) + 2);
