void he8_sim(Int_t nEvents = 10, TString mcEngine = "TGeant4")
{
   ...
   Double_t NomEnergy = 17.0; // Nominal Energy of the beam: Only used for cross section calculation (Tracking energy is
   ...
   // ATTPC_d2He* d2He = new ATTPC_d2He("d2He",&Zp,&Ap,&Qp,mult,&Pxp,&Pyp,&Pzp,&Mass,&ExE,ResEner,
