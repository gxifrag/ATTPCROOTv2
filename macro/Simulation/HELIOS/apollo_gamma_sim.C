...
maximum multiplicity has been set to 10 particles. Double_t px = 0.000/a;  // X-Momentum / per nucleon!!!!!! Double_t py
= 0.000/a;  // Y-Momentum / per nucleon!!!!!! Double_t pz = 2.898/a;  // Z-Momentum / per nucleon!!!!!! Double_t
BExcEner = 0.0; Double_t Bmass = 29.9904; //Mass in GeV Double_t NomEnergy = 1.2; //Used to force the beam to stop
within a certain energy range. Double_t TargetMass = 3.01605;//Mass in GeV
...
//primGen->SetBeam(1,1,0,0); //These parameters change the position of the vertex of every track added to the Primary
Generator
...
number of particles must be the same) ResEner = 0.0; // Useless
