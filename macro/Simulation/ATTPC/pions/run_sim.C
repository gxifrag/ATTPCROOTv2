void run_sim(Int_t nEvents = 50, TString mcEngine = "TGeant4")
{
   ...
   */
   ...
   FairPrimaryGenerator *primGen = new FairPrimaryGenerator();
   auto ionGen = new FairIonGenerator(9,25,9,1,0.,0.,3000, 0.,0., -50.); // Z, A, Q, Multiplicity, Px, Py, Pz, Excitation Energy, Mass, Nominal Energy
