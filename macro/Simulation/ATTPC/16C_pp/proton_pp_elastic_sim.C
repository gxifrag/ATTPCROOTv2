void proton_pp_elastic_sim(Int_t nEvents = 100, TString mcEngine = "TGeant4")
{
  TString dir = getenv("VMCWORKDIR");

   // Output file name
   TString outFile = "./data/attpcsim_pp.root";

   // Parameter file name
   TString parFile = "./data/attpcpar_pp.root";
   ...
   Double_t pz = 0.533 / a; //GeV/c: Z-Momentum / per nucleon!!!!!! 11MeV/u
   Double_t BExcEner = 0.0;
   Double_t Bmass = 1.0078250322; // uma
   Double_t NomEnergy =0.0393; // Nominal Energy in MeV/u
  ...
  ResEner = 140.0; // MeV
   ...
   run->CreateGeometryFile("./data/geofile_full_pp.root");
   // ------------------------------------------------------------------------
