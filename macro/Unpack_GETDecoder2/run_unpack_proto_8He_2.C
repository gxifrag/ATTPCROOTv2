void run_unpack_proto_8He_2(
   TString dataFile = "/data/ND/Summer_2015/run_0190/CoBo_AsAd0_2015-08-08T14:39:55.611_0000.graw",
   TString parameterFile = "pATTPC.TRIUMF2015.par")
{
   // void run_unpack_proto_8He_2(TString dataFile = "runfiles/TRIUMF/8He_TRIUMF_run_merged.txt",TString parameterFile =
   // "pATTPC.TRIUMF2015.par"){ void run_unpack_proto_8He_2(TString dataFile =
   // "/data/TRIUMF/ISAC_2015/CoBo_AsAd0_2015-12-06T01:48:29.974_0000.graw",TString parameterFile =
   // "pATTPC.TRIUMF2015.par"){ void run_unpack_proto_8He_2(TString dataFile =
   // "/run/media/ayyadlim/ISAC_PATTPC_2015/Production/CoBo_AsAd0_2015-12-07T01:55:27.343_0016.graw",TString
   // parameterFile = "pATTPC.TRIUMF2015.par"){
   ...
   if (dataFile.EndsWith(".txt")) {
      ...
      decoderTask->AddData(dataFile.Data());
