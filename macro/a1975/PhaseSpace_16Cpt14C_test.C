...
void PhaseSpace_1n_16Cpt14C_binWidth( int Nbin, double MinLim, double MaxLim, double sigma_Ex, double thetaCM_min, double thetaCM_max, double theta_min, double theta_max , double T_min, double T_max, int SavingDataFile, TString OutputFileName_1n ) {
...
void PhaseSpace_2n_16Cpt14C_binWidth( int Nbin, double MinLim, double MaxLim, double sigma_Ex,double thetaCM_min, double thetaCM_max, double theta_min, double theta_max , double T_min, double T_max, int SavingDataFile, TString OutputFileName_2n ) {
...
void PhaseSpace_16Cpt14C_test() {
	...
	PhaseSpace_1n_16Cpt14C_binWidth( Nbin, MinLim, MaxLim, sigma_Ex, thetaCM_min, thetaCM_max, theta_min, theta_max, T_min, T_max, SavingDataFile, OutputFileName_1n  ) ;
	
	TString OutputFileName_2n = "PhaseSpace_16C_pt_2n.root" ;
	PhaseSpace_2n_16Cpt14C_binWidth( Nbin, MinLim, MaxLim, sigma_Ex, thetaCM_min, thetaCM_max, theta_min, theta_max, T_min, T_max, SavingDataFile, OutputFileName_2n  ) ;
