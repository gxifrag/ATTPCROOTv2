...
//---------------- Fitting the experimental data ----------------//
   ...
   // Breit-Wigner (2)
   TF1 *bwprefit2 = new TF1("bw2", "[0]*TMath::BreitWigner(x,[1],[2])", 9.0,9.8);
   ...
   TF1 * gausprefit2 = new TF1("gausprefit2", "gaus(0)", m2-1.0, m2+1.0);
   ...
   TLine *vline1 = new TLine(8.176, 0, 8.176, 160);
...
//--------------------------------------------------------------------------------------------
   ...
   TF1* fModel = new TF1("fModel",
                        model,
                        -1., 13.,13, //number fitted parameters //13
                        "SpectralModel");
   ...
   TLine *vline0 = new TLine(8.176, 0, 8.176, 163);
   ...
   if (h_PS_1n->GetNbinsX() > 0) {
      ...
      //h_PS_1n->Scale(1e-4); // Scaling factor to visualize better
   }
