...
void PhaseSpace_1n_16Cpd15C_binWidth(int Nbin, double MinLim, double MaxLim, double sigma_Ex, double thetaCM_min,
...
void PhaseSpace_2n_16Cpd15C_binWidth(int Nbin, double MinLim, double MaxLim, double sigma_Ex, double thetaCM_min,
                                     double thetaCM_max, double theta_min, double theta_max, double T_min, double T_max,
...
void PhaseSpace_16Cpd15C_test()
{
   ...
   PhaseSpace_2n_16Cpd15C_binWidth( Nbin, MinLim, MaxLim, sigma_Ex, thetaCM_min, thetaCM_max, theta_min, theta_max,
