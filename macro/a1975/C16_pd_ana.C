...
void C16_pd_ana()
{
   ...
   for (auto filename : filenames) {
      ...
      for (int i = 0; i < Tphysics->GetEntries(); i++) {
         ...
         Double_t Ebeam_at_z = elossTableH2->GetEnergy(Ebeam_buff, zPos * 1000); // check units!
        // std::cout<<" Beam energy at z : "<<Ebeam_at_z<< "  " <<  "z:" << zPos*1000 << "\n";
   ...
   TString fileKine2 =
      "/home/georgina/fair_install/ATTPCROOTv2/macro/Kinematics/Decay_kinematics/C16_pd_C15_1st_Ebeam11_5.txt";
