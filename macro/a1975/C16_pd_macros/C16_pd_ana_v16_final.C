  ...
  for (size_t i = 0; i < angularBins.size(); ++i) {
   ...
   for (auto filename : filenames) {
      ...
      for (int i = 0; i < Tphysics->GetEntries(); i++) {
         ...
         if (ex_energy_corr_shifted > 0.4 && ex_energy_corr_shifted < 1.2 && theta_cm_corr > theta_deg_lower &&
             theta_cm_corr < theta_deg_upper) {
            Double_t theta_deg = theta_cm_corr;
            h740_AngularDistr->Fill(theta_deg);
            h740_ExEnergy->Fill(ex_energy_corr_shifted);
         }

         if (ex_energy_corr_shifted > 3.0 && ex_energy_corr_shifted < 3.8 && theta_cm_corr > theta_deg_lower &&
             theta_cm_corr < theta_deg_upper) {
            Double_t theta_deg = theta_cm_corr;
         ...
         if (ex_energy_corr_shifted > 4.0 && ex_energy_corr_shifted < 5.5 && theta_cm_corr > theta_deg_lower &&
             theta_cm_corr < theta_deg_upper) {
            Double_t theta_deg = theta_cm_corr;
         ...
         if (ex_energy_corr_shifted > 6.0 && ex_energy_corr_shifted < 8.0 && theta_cm_corr > theta_deg_lower &&
             theta_cm_corr < theta_deg_upper) {
            Double_t theta_deg = theta_cm_corr;
