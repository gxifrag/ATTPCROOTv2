...
void C16_pd_ana_v16_15Nov_notShifted()
{
   ...
   TF1 *f2g = new TF1("f2g", "gaus(0) + gaus(3)", 0., 1.7);
   ...
   TF1 *bwprefit3 = new TF1("bw3", "[0]*TMath::BreitWigner(x,[1],[2])", 6.7, 8.2); // 6.2, 8.
   ...
   TF1 *fModel = new TF1("fModel", model, 0., 8., 16, "SpectralModel");
