...
if (guardar_en_pdf) {
  ...
  for (size_t i = 0; i < angularBins.size(); ++i) {
   ...
   filenames.push_back("run_0104_1H.root");
   filenames.push_back("run_0105_1H.root");
   filenames.push_back("run_0106_1H.root");
   filenames.push_back("run_0107_1H.root");
   filenames.push_back("run_0108_1H.root");
   filenames.push_back("run_0109_1H.root");
   filenames.push_back("run_0110_1H.root");
   //filenames.push_back("run_0111_1H.root");
   filenames.push_back("run_0112_1H.root");
   filenames.push_back("run_0113_1H.root");
   filenames.push_back("run_0114_1H.root");
   filenames.push_back("run_0115_1H.root");
   filenames.push_back("run_0116_1H.root");
   filenames.push_back("run_0117_1H.root");
   filenames.push_back("run_0118_1H.root");
   filenames.push_back("run_0119_1H.root");
   filenames.push_back("run_0120_1H.root");
   // filenames.push_back("run_0121_1H.root");
   filenames.push_back("run_0122_1H.root");
   filenames.push_back("run_0123_1H.root");
   filenames.push_back("run_0124_1H.root");
   filenames.push_back("run_0125_1H.root");
   filenames.push_back("run_0126_1H.root");
   filenames.push_back("run_0127_1H.root");
   filenames.push_back("run_0128_1H.root");
   filenames.push_back("run_0129_1H.root");
   filenames.push_back("run_0130_1H.root");
   filenames.push_back("run_0131_1H.root");
   filenames.push_back("run_0132_1H.root");
   filenames.push_back("run_0133_1H.root");
   filenames.push_back("run_0134_1H.root");
   filenames.push_back("run_0135_1H.root");
   filenames.push_back("run_0136_1H.root");
   filenames.push_back("run_0137_1H.root");
   filenames.push_back("run_0138_1H.root");
   filenames.push_back("run_0139_1H.root");
   filenames.push_back("run_0140_1H.root");
   filenames.push_back("run_0141_1H.root");
   filenames.push_back("run_0142_1H.root");
   filenames.push_back("run_0143_1H.root");
   filenames.push_back("run_0144_1H.root");
   filenames.push_back("run_0145_1H.root");
   filenames.push_back("run_0146_1H.root");
   filenames.push_back("run_0147_1H.root");
   // filenames.push_back("run_0148_1H.root");
   //filenames.push_back("run_0149_1H.root");
   filenames.push_back("run_0150_1H.root");
   filenames.push_back("run_0151_1H.root");
   filenames.push_back("run_0152_1H.root");
   filenames.push_back("run_0153_1H.root");
   filenames.push_back("run_0154_1H.root");
   filenames.push_back("run_0155_1H.root");
   filenames.push_back("run_0156_1H.root");
   filenames.push_back("run_0157_1H.root");
   filenames.push_back("run_0158_1H.root");
   filenames.push_back("run_0159_1H.root");
   filenames.push_back("run_0160_1H.root");
   filenames.push_back("run_0161_1H.root");
   filenames.push_back("run_0162_1H.root");
   filenames.push_back("run_0163_1H.root");
   filenames.push_back("run_0164_1H.root");
   filenames.push_back("run_0165_1H.root");
   filenames.push_back("run_0166_1H.root");
   filenames.push_back("run_0167_1H.root");
   filenames.push_back("run_0168_1H.root");
   filenames.push_back("run_0169_1H.root");
   filenames.push_back("run_0170_1H.root");
   filenames.push_back("run_0171_1H.root");
   filenames.push_back("run_0172_1H.root");
   filenames.push_back("run_0173_1H.root");
   filenames.push_back("run_0174_1H.root");
   filenames.push_back("run_0175_1H.root");
   filenames.push_back("run_0176_1H.root");
   filenames.push_back("run_0177_1H.root");
   filenames.push_back("run_0178_1H.root");
   filenames.push_back("run_0179_1H.root");
   filenames.push_back("run_0180_1H.root");
   filenames.push_back("run_0181_1H.root");
   filenames.push_back("run_0182_1H.root");
   filenames.push_back("run_0183_1H.root");
   filenames.push_back("run_0184_1H.root");
   filenames.push_back("run_0185_1H.root");
   filenames.push_back("run_0186_1H.root");
   filenames.push_back("run_0187_1H.root");
   filenames.push_back("run_0188_1H.root");
   filenames.push_back("run_0189_1H.root");
   ...
   for (auto filename : filenames) {
      ...
      new TFile("/home/georgina/C16_analysis/C16_H2/output_a1975_22April_tb510_MMG20/InterpSolver/InterpSolver_pp_root/" + filename, "R");
      ...
      size_t pos = estimation_filename.find("_1H");
      if (pos != std::string::npos) {
         estimation_filename.erase(pos, 3); // elimina "_1H"
      }
      ...
      for (int i = 0; i < Tphysics->GetEntries(); i++) {
        ...
        //Corrección cinemática
         ...
         //double theta_lab_corr=(theta-(2.0*TMath::Pi()/4000) * (E_ej - kethe)); //theta: rad; theta_lab_corr: rad; E_ej-kethe: MeV 29.5
         ...
         Ang_Ener_Corr->Fill(theta_lab_corr* TMath::RadToDeg(), E_ej); //theta lab!! -> I still have to implement the correction of catima?
         

         // Validación ANTES de CATIMA — añade esto al principio del loop de eventos
         /*double zPos_cm = zPos * 100.0;
         if(TMath::IsNaN(zPos) || zPos_cm <= 0.0 || zPos_cm >= 80.0) continue;
         if(TMath::IsNaN(Brho) || Brho <= 0.0) continue;
         if(TMath::IsNaN(theta) || theta <= 0.0) continue;

         // Luego el fill sin el corte de E_ej para ver todos los estados
         if (zPos_cm > 2.0 && zPos_cm < 60.0){
            ExCorrvsZpos->Fill(ex_energy_corr, zPos_cm);
            hexCorr->Fill(ex_energy_corr);
            hexCorr2->Fill(ex_energy_corr);
         }*/
...
//-------------------- PHASE SPACE ----------------------------------------------
   ...
   TFile *filePS = new TFile("/home/georgina/fair_install/ATTPCROOTv2/macro/a1975/PhaseSpace/PhaseSpace_16C_pd_1n.root", "READ");
   ...
   for( int i = 0 ; i < treePS->GetEntries() ; i++ ) {
		...
		if ( ThetaCM_cal > ThetaCM_min && ThetaCM_cal < ThetaCM_max ) {
			h_PS_1n -> Fill( Ex_cal+0.9, Weight_sim ) ;	
		}	
	}

    cout << "Integral original = " << h_PS_1n->Integral() << endl;
    cout << "Max original = " << h_PS_1n->GetMaximum() << endl;

   std::cout << "Entries en PS tree = " << treePS->GetEntries() << std::endl;
...
//---------------- Fitting the experimental data ----------------//
   ...
   TF1 *f2g = new TF1("f2g", "gaus(0) + gaus(3)",0.2, 1.6);
  ...
  /* f2g->SetParameter(1, m1);   // mean of gaus(0)
   ...
   cout << "Peaks found at: " << m3 << " MeV, " << m4 << " MeV, " << m5 << " MeV\n";

   // 2nd excited — bien definido en ~3.87 MeV
   TF1 *bwprefit1 = new TF1("bw1", "[0]*TMath::BreitWigner(x,[1],[2])", 3.2, 4.3);
   ...
   hexCorr->Fit(bwprefit2, "R+");

   // 4th excited — fijar posición manualmente, TSpectrum lo ve en 7.3
   TF1 *bwprefit3 = new TF1("bw3", "[0]*TMath::BreitWigner(x,[1],[2])", 6.5, 8.0);
  ...
  SpectralModelSeg* model = new SpectralModelSeg(graphPS);
   TF1* fModel = new TF1("fModel",
                        model,
                        0.2, 10.,16, //number fitted parameters
                        "SpectralModelSeg");
...
//phase space
fModel->SetParLimits(15, 0.0, 1.0);  // o un límite razonable

if (!hexCorr2) { std::cerr << "hexCorr2 is null\n"; return; }
if (!hPS_prefit)  { std::cerr << "hPS_prefit is null\n"; return; }
if (!graphPS)     { std::cerr << "graphPS is null\n"; return; }
  ...
  // hexCorr2->Draw("E1"); //E1
   ...
   /*TLine *vline0 = new TLine(1.218, 0, 1.218, 550); // línea vertical en x=1.218 MeV;
   ...
   if (hPS_final->GetNbinsX() > 0) {
      hPS_final->Scale(globalParamsFinals[15]); // globalParamsFinals[15] es el factor de escala ajustado para el fondo de fase espacio
      cout << "Phase Space scale factor (initial): " << globalParamsIni[15] << endl;
      cout << "Phase Space scale factor (final): " << globalParamsFinals[15] << endl;
      cout << "PS max = " << hPS_final->GetMaximum() << endl;
   }
...
// Loop de dibujo — fuera del loop de carga
for (size_t i = 0; i < graphs.size(); i++) {
   if(graphs[i] == nullptr) continue;
   if(graphs[i]->GetN() == 0) continue;
...
/*for (int i = 0; i < hHex.size(); i++) {
   ...
   for(int i=0;i<nfound; ++i){
    ...
    fExSpectra_vec[i] = new TF1(Form("fExSpectra%d", i+1),
        "gaus(0) + gaus(3) + [6]*TMath::BreitWigner(x,[7],[8]) + [9]*TMath::BreitWigner(x,[10],[11]) + [12]*TMath::BreitWigner(x,[13],[14])", -1, 9.);
