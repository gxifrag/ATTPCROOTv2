...
void LoadHitsROOT(const char* filename = "/home/georgina/fair_install/ATTPCROOTv2_KF/macro/Simulation/ATTPC/protons/data/protonssim_2T_H300torr_50MeV.root", int targetEvent = 11) 
{
    posX.clear(); 
    posY.clear(); 
    posZ.clear(); 
                ...
                double mass, double charge, int Z, int A, ROOT::Math::XYZVector initialMom, int trackID)
{
   ...
   propagator.SetBField({0, 0, 2.00});//2.85 T
