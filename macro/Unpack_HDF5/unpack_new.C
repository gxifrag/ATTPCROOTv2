...
void unpack_new(int runNumberS800 = 2063, int runNumberATTPC = 63)
{
   ...
   // TString inputFile =
   // TString::Format("/mnt/rawdata/ceclub/giraud/attpc/ATTPCROOTv2/macro/Unpack_HDF5/hdf5Files/run_0002.h5",
   // runNumberATTPC);

   // Set the output file
   //  TString outputFile = TString::Format("/mnt/analysis/e18008/rootMerg/run_2%03d_%04d.root", runNumberS800,
   //  runNumberATTPC);
   TString outputFile =
      TString::Format("/mnt/analysis/e18008/rootMerg/jcz_test/run_%04d_%04d.root", runNumberS800, runNumberATTPC);
   // TString outputFile =
   ...
   // S800File = TString::Format("/mnt/analysis/e18008/rootS800/cal/run-2%03d-00.root", runNumberS800);
