{
   ...
   // cuts1->Draw("same");
   ch->Draw("Ex4>>h1(100,-50,50",
            "theta1>7.0*3.41/180.0 && theta1<170*3.14/180.0 && vertexZ>70 && theta_cm>1.0 && theta_cm<2.0 ", "");
   ...
   ch->Draw("Ex4>>h2(100,-50,50",
            "theta1>7.0*3.41/180.0 && theta1<90*3.14/180.0 && vertexZ>70 && Ni69 && theta_cm>1.0 && theta_cm<2.0", "");
   c->cd(4);
   // ch->Draw("Ex4>>h11(120,-50,50","theta1>7.0*3.41/180.0 && theta1<170*3.14/180.0 && vertexZ>50","");
   ch->Draw("Ex4>>h3(100,-50,50",
            "theta1>7.0*3.41/180.0 && theta1<90*3.14/180.0 && vertexZ>70 && Ni68 && theta_cm>1.0 && theta_cm<2.0", "");
   c->cd(5);
   // ch->Draw("vertexZ:theta1*TMath::RadToDeg()","","");
   ch->Draw("Ex4>>h4(50,-50,50",
            "theta1>7.0*3.41/180.0 && theta1<90*3.14/180.0 && vertexZ>70 && Ni67 && theta_cm>1.0 && theta_cm<2.0", "");
   c->cd(6);
   // ch->Draw("vertexZ:theta1*TMath::RadToDeg()","","");

   ch->Draw("Ex4>>h5(100,-50,50",
            "theta1>7.0*3.41/180.0 && theta1<90*3.14/180.0 && vertexZ>70 && Ni66 && theta_cm>1.0 && theta_cm<2.0", "");

   // ch->Draw("Ex4>>hh(100,-50,50","theta1>7.0*3.14/180.0 && theta1<170*3.14/180.0 && vertexZ>50 && eLoss_p1_reco<1.5
   // && theta_cm>0.5",""); ch->Draw("Ex4>>h12(350,-10,40","theta1>20.0*3.14/180.0 && theta1<170*3.14/180.0 && vertexZ>0
   // && MaxR1<240.0","");
}
