...
kf::Vector<DIM_Z> covertCartesian2Polar(const kf::Vector<DIM_X> &cartesian)
{
   const kf::Vector<DIM_Z> polar{std::sqrt(cartesian[0] * cartesian[0] + cartesian[1] * cartesian[1]),
...
kf::Matrix<DIM_Z, DIM_Z> calculateJacobianMatrix(const kf::Vector<DIM_X> &vecX)
{
   ...
   matHj << (vecX[0] / valSqrtX2PlusY2), (vecX[1] / valSqrtX2PlusY2), (-vecX[1] / valX2PlusY2), (vecX[0] / valX2PlusY2);
